...
def parser():
    ...
    parser.add_argument(
        "--process_name", "-pn", type=str, default="devide_anno", help="process name"
    )
    ...
    parser.add_argument(
        ...
        "-xp",
        type=str,
        default="../images/flowchart-example163.xml",
        help="image path",
    )
    parser.add_argument(
        "--output_dir",
...
def convert_voc_folder_to_coco(voc_folder: str, output_dir: str):
    ...
    for file in os.listdir(voc_folder):
        ...
        # ここで毎回初期化（重要！）
        coco = {"images": [image_info], "annotations": anns, "categories": categories}
...
def split_coco_by_image(coco_data: dict, output_dir: str):
    ...
    for image_info in coco_data["images"]:
        ...
        # 構造を保存
        image_coco_data = {"images": [image_info], "annotations": annotations_for_image}
...
if __name__ == "__main__":
    ...
    if args.process_name == "devide_anno":
        ...
        convert_voc_folder_to_coco(voc_folder="../xml/", output_dir="../json/")
